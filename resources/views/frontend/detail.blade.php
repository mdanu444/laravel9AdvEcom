...
<div class="span9">
    <ul class="breadcrumb">
        ...
        <li><a href="{{ url($url) }}">{{ $url_status == 'category_url' ? $product->product_categories->title : $product->product_sub_categories->title }}</a> <span class="divider">/</span></li>
        <li class="active">{{ $product->title }}</li>
    </ul>
    <div class="row">
        <div id="gallery" class="span3">
            <a href="{{ url('images/product_image/larg/'.$product->image) }}" title="{{ $product->title }}">
                <img src="{{ url('images/product_image/larg/'.$product->image) }}" style="width:100%" alt="{{ $product->title }}"/>
            </a>
            <div id="differentview" class="moreOptopm carousel slide">
                <div class="carousel-inner">
                    <div class="item active">
                        @foreach ($images as $image)
                        <a href="{{ url('images/product_image/alternative/'.$image->title) }}"> <img style="width:29%" src="{{ url('images/product_image/alternative/'.$image->title) }}" alt=""/></a>
                        @endforeach
                    </div>
                ...
                <div class="tab-pane fade active in" id="home">
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr class="techSpecRow"><td class="techSpecTD1">Brand: </td><td class="techSpecTD2">{{ $product->brands_id != 0 ? $product->brands->title:"No Brand" }}</td></tr>
                            <tr class="techSpecRow"><td class="techSpecTD1">Code:</td><td class="techSpecTD2">{{ $product->code }}</td></tr>
                ...
                <div class="tab-pane fade" id="profile">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane" id="listView">
                            ...
                            <div class="row">
                                <div class="span2">
                                    <img src="{{ url('images/product_image/small/'.$rlprod->image) }}" alt=""/>
                                </div>
                                <div class="span4">
                                    <h3>New | Available</h3>
                                    <hr class="soft"/>
                                    ...
                                    <a class="btn btn-small pull-right" href="{{ route('frontend.product_details',['id' => $rlprod->id]) }}">View Details</a>
                                    <br class="clr"/>
                                </div>
                        ...
                        <div class="tab-pane active" id="blockView">
                            <ul class="thumbnails">
                                ...
                                <li class="span3">
                                    <div class="thumbnail">
                                        <a href="{{route('frontend.product_details', ['id' => $rlprod])}}"><img src="{{ url('images/product_image/small/'.$rlprod->image) }}" alt=""/></a>
                                        <div class="caption">
