...
<div class="container">
    ...
    <p style="font-size: 20px;">You are able to make payment from order details, for payment  <a href="{{ route('frontend.orderdetails', ['id' => Crypt::encryptString(Session::get('order')->id)]) }}">View Order Details</a>.</p>
    ...
    <br>
    <br>
    <a href="{{ route('frontend.cart.index') }}">Go Cart Page.</a>
</div>
</body>
</html>
