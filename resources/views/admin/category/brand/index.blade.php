...
@section('main_content')
    <div class="card">
        <div class="card-header bg-primary">
            ...
            <a href="{{ route('admin.productbrands.create') }}" class="btn btn-light float-right"
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td class="d-flex">
                                <form method="post"
                                    action="{{ route('admin.productbrands.destroy', Crypt::encryptString($item->id)) }}">
                                    @csrf
                                    @method('delete')
                                ...
                                <a class="bg-primary p-3 ml-2"
                                    href="{{ route('admin.productbrands.edit', Crypt::encryptString($item->id)) }}"><i
                                        class="fa fa-pen"></i></a>
                            </td>
                        </tr>
                    @endforeach
