            ...
            <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('title') }}" class="form-control col-md-11" type="text" name="title"
                            id="title">
                        @error('title')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input value="{{ old('code') }}" class="form-control col-md-11" type="text" name="code"
                            id="code">
                        @error('code')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input value="{{ old('color') }}" class="form-control col-md-11" type="text" name="color"
                            id="color">
                        @error('color')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input value="{{ old('unit') }}" class="form-control col-md-11" type="text" name="unit"
                            id="unit">
                        @error('unit')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input value="{{ old('weight') }}" class="form-control col-md-11" type="text" name="weight"
                            id="weight">
                        @error('weight')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input value="{{ old('price') }}" class="form-control col-md-11" type="number" min="5"
                            name="price" id="price">
                        @error('price')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input value="{{ old('discount') }}" class="form-control col-md-11" type="number" min="0"
                    ...
                    <div class="">
                        ...
                        <input value="{{ old('wash_care') }}" class="form-control col-md-11" type="text"
                    ...
                    <div class="">
                        ...
                        <input value="{{ old('occassion') }}" class="form-control col-md-11" type="text"
                    ...
                    <div class="">
                        ...
                        <input value="{{ old('meta_title') }}" class="form-control col-md-11" type="text"
                    ...
                    <div class="">
                        ...
                        <input value="{{ old('meta_keywords') }}" class="form-control col-md-11" type="text"
