...
@section('main_content')
    <div class="card col-md-12">
        ...
        <div class="card-body">
            <form action="{{ route('admin.product.update', Crypt::encryptString($data->id)) }}" method="POST"
                ...
                <div
                    ...
                    <div class="form-group">
                        ...
                        <select location="admin/getcategorybysection" loadableClass="categoryoptionviewer"
                            class="selectionloader col-md-11 form-control js-example-basic-single selecttion"
                            name="product_sections_id" id="section">
                            <option value="">Select Section</option>
                            @foreach ($sections as $section)
                                <option @if ($data->product_sections_id == $section->id) selected @endif
                    ...
                    <div class="form-group">
                        ...
                        <select location="admin/getsubcategorybysection" loadableClass="subcategoryoptionviewer"
                            class=" col-md-11 categoryoptionviewer selecttion form-control js-example-basic-single"
                            name="product_categories_id" id="selectionloader">
                            <option value="">Select Category</option>

                            @foreach ($category as $cat)
                                <option @if ($data->product_categories_id == $cat->id) selected @endif
                    ...
                    <div class="form-group">
                        ...
                        <select class="col-md-11 subcategoryoptionviewer selecttion form-control js-example-basic-single"
                            ...
                            @foreach ($subcategory as $subcat)
                                <option @if ($data->product_sub_categories_id == $subcat->id) selected @endif
                    ...
                    <div class="form-group">
                        ...
                        <select class="col-md-11 form-control selecttion" name="brands_id" id="brand">
                            ...
                            <option value="{{ Crypt::encryptString(0) }}" {{ $data->brands_id == 0 ? 'selected' : '' }}>None
                            </option>
                            @foreach ($brands as $brand)
                                <option @if ($data->brands_id == $brand->id) selected @endif
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $data->title }}" class="form-control col-md-11" type="text" name="title"
                            id="title">
                        @error('title')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input value="{{ $data->code }}" class="form-control col-md-11" type="text" name="code"
                            id="code">
                        @error('code')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input value="{{ $data->color }}" class="form-control col-md-11" type="text" name="color"
                            id="color">
                        @error('color')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input value="{{ $data->unit }}" class="form-control col-md-11" type="text" name="unit"
                            id="unit">
                        @error('unit')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input value="{{ $data->weight }}" class="form-control col-md-11" type="text" name="weight"
                            id="weight">
                        @error('weight')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input value="{{ $data->price }}" class="form-control col-md-11" type="number" min="5"
                            name="price" id="price">
                        @error('price')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input value="{{ $data->discount }}" class="form-control col-md-11" type="number" min="0"
                    ...
                    <div>
                        <img height="100" width="100" src="{{ url('images/product_image/small/' . $data->image) }}"
                            alt="">
                    </div>
                    <div class="">
                        <label for="video">Upload Video</label>
                        <input class="form-control col-md-11" type="file" accept="video/*" name="video"
                            id="video">
                        @error('video')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input class="form-control col-md-11" accept="image/*" type="file" name="image"
                            id="image">
                        @error('image')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="">
                        ...
                        <input value="{{ $data->wash_care }}" class="form-control col-md-11" type="text"
                    ...
                    <div class="">
                        ...
                        <select class="col-md-11 form-control selecttion" name="fabric" id="fabric">
                            ...
                            <option {{ $data->fabric == 'Mixed fabrics' ? 'selected' : '' }} value="Mixed fabrics">Mixed
                                fabrics</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="col-md-11 form-control selecttion" name="sleeve" id="sleeve">
                            <option {{ $data->sleeve == 'Full Sleeve' ? 'selected' : '' }} selected value="Full Sleeve">Full
                                Sleeve</option>
                            <option {{ $data->sleeve == 'Half Sleeve' ? 'selected' : '' }} value="Half Sleeve">Half Sleeve
                            </option>
                            <option {{ $data->sleeve == 'Short Sleeve' ? 'selected' : '' }} value="Short Sleeve">Short Sleeve
                            </option>
                            <option {{ $data->sleeve == 'Sleeveless' ? 'selected' : '' }} value="Sleeveless">Sleeveless
                            </option>
                            <option {{ $data->sleeve == 'Sleeveless' ? 'selected' : '' }} value="Sleeveless">Sleeveless
                            </option>
                    ...
                    <div class="">
                        ...
                        <input value="{{ $data->occassion }}" class="form-control col-md-11" type="text"
                            name="occassion" id="occassion">
                        @error('occassion')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="">
                        ...
                        <input value="{{ $data->meta_title }}" class="form-control col-md-11" type="text"
                    ...
                    <div class="">
                        ...
                        <input value="{{ $data->meta_keywords }}" class="form-control col-md-11" type="text"
                    ...
                    <div class="">
                        ...
                        <textarea value="" class="form-control col-md-11" type="textarea" name="meta_description"
                            id="meta_description">{{ $data->meta_description }}</textarea>
