...
@section('main_content')
        ...
        <div class="card-body">
            <form action="{{ route('admin.p_attribute.store', Crypt::encryptString($product->id)) }}" method="post">
                ...
                <div class="field_wrapper">
                    <div
                        style="display: grid; grid-template-columns: auto auto auto auto auto; grid-gap: 10px 10px; margin-bottom: 10px;">
    ...
    <div class="card">
        <div class="card-header bg-primary">
            ...
            <a href="{{ route('admin.productsections.create') }}" class="btn btn-light float-right"
                ...
                <tbody>
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td class="d-flex">
                                <form method="post"
                                    action="{{ route('admin.p_attribute.destroy', [Crypt::encryptString($product->id), Crypt::encryptString($item->id)]) }}">
                                    @csrf
                                    @method('delete')
